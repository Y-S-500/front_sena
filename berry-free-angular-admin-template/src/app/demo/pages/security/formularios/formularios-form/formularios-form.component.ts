...
export class FormulariosFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.listIcons = [
      ...
      { textoMostrar: "fa-duotone fa-gauge-circle-plus", name: "Recargo" },
      { textoMostrar: "fa-duotone fa-ticket", name: "contrato" },
      { textoMostrar: "fa-duotone fa-person-to-door", name: "control-acceso" },
      { textoMostrar: "fa-duotone fa-business-time", name: "horario" },
      { textoMostrar: "fa-duotone fa-watch-smart", name: "permisos" },
      { textoMostrar: "fa-duotone fa-camera-movie", name: "videos" },
      { textoMostrar: "fa-duotone fa-money-check-dollar-pen", name: "Cotizaciones" },
      {textoMostrar: "fa-duotone fa-circle-parking", name : "Estacionamiento"},
      {textoMostrar: "fa-duotone fa-distribute-spacing-horizontal", name : "Cupo"},
      {textoMostrar: "fa-duotone fa-taxi-bus", name : "TiposVehiculos"},
      {textoMostrar: "fa-duotone fa-car-tilt", name : "Vehiculos"},
      {textoMostrar: "fa-duotone fa-memo-circle-info", name : "Detalles"},
      {textoMostrar: "fa-duotone fa-map-location-dot", name : "ZonaParking"},
      {textoMostrar: "fa-duotone fa-city", name : "Talleres"},
      {textoMostrar: "fa-duotone fa-file-magnifying-glass", name : "Seguimientos"},
      {textoMostrar: "fa-duotone fa-solid fa-calendar-range", name : "Calendar"},
      {textoMostrar: "fa-duotone fa-solid fa-person-walking-dashed-line-arrow-right", name : "Visitas"},
      {textoMostrar: "fa-duotone fa-solid fa-person-walking-dashed-line-arrow-right", name : "Visitas"},
      {textoMostrar: "fa-duotone fa-solid fa-people-roof", name : "Visitantes"},
