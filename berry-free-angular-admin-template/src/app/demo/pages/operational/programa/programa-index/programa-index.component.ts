...
@Component({
  ...
  styleUrl: './programa-index.component.scss'
})
export class ProgramaIndexComponent {
  ...
  nuevo() {
    const modalRef = this.modalService.open(ProgramaFormComponent);
  ...
  data(): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
      this.service.datatable("Programa", data).subscribe(
        (datos) => {
          resolve(datos);
        },
        (error) => {
