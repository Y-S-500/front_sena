...
export class BotonesComponent implements OnInit {
  ...
  @Output() eventHuella = new EventEmitter<any>();
  ...
  @Output() eventImportarProductos = new EventEmitter<any>();
  ...
  @Output() eventVentasProducto = new EventEmitter<any>();
  @Output() eventVentasMesero = new EventEmitter<any>();
  @Output() eventPlantillaProductos = new EventEmitter<any>();
